	...
	<div class="col-lg-4">
			  ...
			  <li class="dropdown active">
			    ...
			    <ul class="dropdown-menu">
			     ...
			     <li><?php echo anchor("baptism/baptismList", 'View Baptism Records'); ?></li>

			     <li class="divider"></li> 
			      
			     <li><?php echo anchor("updateRecords/updateList", 'Update Records'); ?></li>
	...
	<div class="col-lg-8">
      ...
      <?php echo form_open("marriage/deleteMember");  ?>
	   ...
	   <div class="row">
	     	...
	     	<input type="submit" value="Delete" class="btn btn-danger" onclick="return ('Are you sure you want to delete the record?')">
